      ...
      <div className='flex flex-1 flex-col justify-center items-center p-8'>
        <div className='w-full max-w-md space-y-6'>
          <div className='text-center'>
            <h2 className='text-3xl font-bold mb-2 text-primary'>Create Account</h2>
            <p className='text-base-content/70 mb-8'>Get started with your free account</p>
          </div>
          ...
          >
            Already have an account? <span className="font-medium text-primary hover:text-primary-focus">Login</span>
          </Link>
        </div>
      </div>
